...
const AdvancedSearchFilterGroup: React.FC<{ open?: boolean }> = ({ open }) => {
  return (
    <li className="advanced-search-filter-group">
      ...
      >
        ...
        <img
          alt=""
          className={`advanced-search-filter-group__chevron ${open ? "advanced-search-filter-group__chevron--expanded" : ""}`}
